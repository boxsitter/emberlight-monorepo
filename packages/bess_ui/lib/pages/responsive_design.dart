...
class ResponsiveDesignScreen extends StatelessWidget {
  const ResponsiveDesignScreen({super.key = const ValueKey('ResponsiveDesignScreen')});

  @override
  Widget build(BuildContext context) {
    return const BessSiteTemplate(desktop: ResponsiveDesignDesktop(), tablet: ResponsiveDesignTablet(), mobile: ResponsiveDesignMobile());
  }
}
